...
# 2. Create variables totalmonths, total, difference
...
#13. Open the output file as CSV in anaysis/financial_analysis.csv
#14. From the output list print the output values on the console and print the details in the output file
